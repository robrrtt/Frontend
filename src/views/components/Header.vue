...
<template>
  <header
    class="fixed flex w-full items-center justify-between border-b-2 border-gray-200 bg-white p-2"
  >
    <!-- logo -->
    <div class="flex items-center space-x-2">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" class="w-11 h-11" viewBox="0 0 48 48">
        <path
          fill="#ededed"
          fill-rule="evenodd"
    ...
    <div class="relative">
      <button
        class="outline-2 outline-blue-500/50 h-9 w-9 overflow-hidden rounded-full"
        @click="toggleProfile"
      >
        <svg
